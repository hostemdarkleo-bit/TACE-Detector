...
from tace_max import Tace_max
from tace_segment import tace_segment_nobj
from tace_segmentnobj1 import tace_segment_nobj1
...
def procesar_bloque(img_data, block_index, blocks_y, blocks_x,
    ...
    imagen_final, maxima = Tace_max(cout, n_objects)

    # Segmentation
    if analysis_type == "Estático":
        binary_mask, individual_masks = tace_segment_nobj1(cout, n_objects, maxima, fixed_radius)
    else:
        binary_mask, individual_masks = tace_segment_nobj(cout, n_objects, maxima, Radius='adaptive')
